...
<body>
				...
				<div class="topMessage">
					<div class="menu-hd">
						<c:if test="${ empty loginUser }">
							...
							<a href="${pageContext.request.contextPath }/page/regist.jsp"
								target="_top">免费注册</a>
						</c:if>
					...
					<div class="menu-hd">
						<a id="mc-menu-hd" href="#" target="_top">
							<i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong
								id="J_MiniCartNum" class="h">7</strong>
						</a>
					</div>
				</div>
			...
			<div class="search-bar pr">
				...
				<form action="#" method="post">
					<input id="searchInput" name="index_none_header_sysc" type="text"
						...
						id="ai-topsearch" class="submit am-btn" value="搜索" type="submit">
				</form>
			</div>
		</div>
		<div class="clear"></div>
	...
	<div class="shopNav">
		<div class="slideall">
			...
			<div class="nav-cont">
				<ul>
					<li class="index"><a
							href="${pageContext.request.contextPath }/home.jsp">首页</a></li>
				</ul>
			</div>
							...
							<ul class="category-list" id="js_climit_li">
								<li class="appliance js_toggle relative first">
									<div class="category-info">
										<h3 class="category-name b-category-name">
											<i><img
												src="${pageContext.request.contextPath }/images/cake.png"></i>
								...
								<li class="appliance js_toggle relative">
									<div class="category-info">
										<h3 class="category-name b-category-name">
											<i><img
												src="${pageContext.request.contextPath }/images/cookies.png"></i>
														...
														<dl class="dl-sort">
															...
															<dd>
																<a rel="nofollow" title="YYKCLOT" target="_blank"
																	href="#" rel="nofollow">
																	<span class="red">YYKCLOT</span>
																</a>
															</dd>
															<dd>
																<a rel="nofollow" title="池氏品牌男装" target="_blank"
																	href="#" rel="nofollow">
																	<span class="red">池氏品牌男装</span>
																</a>
															</dd>
															<dd>
								...
								<li class="appliance js_toggle relative">
									<div class="category-info">
										<h3 class="category-name b-category-name">
											<i><img
												src="${pageContext.request.contextPath }/images/meat.png"></i>
														...
														<dl class="dl-sort">
															...
															<dd>
																<a rel="nofollow" title="斑蒂尼BONDYNI" target="_blank"
																	href="#" rel="nofollow">
																	<span class="red">斑蒂尼BONDYNI</span>
																</a>
															</dd>
															<dd>
								...
								<li class="appliance js_toggle relative">
									<div class="category-info">
										<h3 class="category-name b-category-name">
											<i><img
												src="${pageContext.request.contextPath }/images/bamboo.png"></i>
								...
								<li class="appliance js_toggle relative">
									<div class="category-info">
										<h3 class="category-name b-category-name">
											<i><img
												src="${pageContext.request.contextPath }/images/nut.png"></i>
								...
								<li class="appliance js_toggle relative">
									<div class="category-info">
										<h3 class="category-name b-category-name">
											<i><img
												src="${pageContext.request.contextPath }/images/candy.png"></i>
								...
								<li class="appliance js_toggle relative">
									<div class="category-info">
										<h3 class="category-name b-category-name">
											<i><img
												src="${pageContext.request.contextPath }/images/chocolate.png"></i>
								...
								<li class="appliance js_toggle relative">
									<div class="category-info">
										<h3 class="category-name b-category-name">
											<i><img
												src="${pageContext.request.contextPath }/images/fish.png"></i>
								...
								<li class="appliance js_toggle relative">
									<div class="category-info">
										<h3 class="category-name b-category-name">
											<i><img
												src="${pageContext.request.contextPath }/images/tea.png"></i>
												...
												<div class="menu-srot">
													...
													<div class="brand-side">
														<dl class="dl-sort">
															...
															<dd>
																<a title="今生只围你" target="_blank" href="#" rel="nofollow">
																	<span>今生只围你</span>
																</a>
															</dd>
															<dd>
																<a title="忆佳人" target="_blank" href="#" rel="nofollow">
																	<span class="red">忆佳人</span>
																</a>
															</dd>
															<dd>
																<a title="斐洱普斯" target="_blank" href="#" rel="nofollow">
																	<span class="red">斐洱普斯</span>
																</a>
															</dd>
															<dd>
																<a title="聚百坊" target="_blank" href="#" rel="nofollow">
																	<span class="red">聚百坊</span>
																</a>
															</dd>
															<dd>
								...
								<li class="appliance js_toggle relative last">
									<div class="category-info">
										<h3 class="category-name b-category-name">
											<i><img
												src="${pageContext.request.contextPath }/images/package.png"></i>
												...
												<div class="menu-srot">
													...
													<div class="brand-side">
														<dl class="dl-sort">
															...
															<dd>
																<a title="琳琅鞋业" target="_blank" href="#" rel="nofollow">
																	<span>琳琅鞋业</span>
																</a>
															</dd>
															<dd>
																<a title="宏利鞋业" target="_blank" href="#" rel="nofollow">
																	<span>宏利鞋业</span>
																</a>
															</dd>
															<dd>
															...
															<dd>
																<a title="浪人怪怪" target="_blank" href="#" rel="nofollow">
																	<span>浪人怪怪</span>
																</a>
															</dd>
														</dl>
			...
			<div class="am-g am-g-fixed smallnav">
				<div class="am-u-sm-3">
					<a href="sort.html">
						<img src="${pageContext.request.contextPath }/images/navsmall.jpg" />
						<div class="title">商品分类</div>
					</a>
				</div>
				<div class="am-u-sm-3">
					<a href="#">
						<img src="${pageContext.request.contextPath }/images/huismall.jpg" />
						<div class="title">大聚惠</div>
					</a>
				</div>
				<div class="am-u-sm-3">
					<a href="#">
						<img src="${pageContext.request.contextPath }/images/mansmall.jpg" />
			...
			<div class="marqueen">
				...
				<div class="demo">
					...
					<ul>
						...
						<li class="title-first"><a target="_blank" href="#">
								<span>[公告]</span>商城与广州市签署战略合作协议 <img
									src="${pageContext.request.contextPath }/images/TJ.jpg"></img>
								<p>XXXXXXXXXXXXXXXXXX</p>
							</a></li>

						<div class="mod-vip">
							<div class="m-baseinfo">
								<a href="${pageContext.request.contextPath }/person/index.html">
									<img
										src="${pageContext.request.contextPath }/images/getAvatar.do.jpg">
								</a>
								<em> Hi,<span class="s-name">小叮当</span> <a href="#">
										<p>点击更多优惠活动</p>
									</a>
								</em>
							</div>
			...
			<div class="am-g am-g-fixed recommendation">
				...
				<div class="am-u-sm-4 am-u-lg-3 ">
					...
					<div class="recommendationMain ">
						<img src="${pageContext.request.contextPath }/images/tj.png "></img>
					</div>
				</div>
				<div class="am-u-sm-4 am-u-lg-3 ">
					<div class="info ">
			...
			<div class="am-g am-g-fixed floodOne ">
				...
				<div class="am-u-sm-7 am-u-md-5 am-u-lg-4">
					<div class="text-two">
						...
						<a href="# ">
							<img src="${pageContext.request.contextPath }/images/act2.png " />
						</a>
					</div>
				...
				<div class="am-u-sm-12 am-u-md-4 ">
					<div class="am-u-sm-3 am-u-md-6 text-three">
						...
						<a href="# ">
							<img src="${pageContext.request.contextPath }/images/act3.png " />
						</a>
					</div>
					...
					<div class="ibar_login_box status_login ">
						<c:if test="${ not empty loginUser }">
							<div class="avatar_box ">
								...
								<ul class="user_info ">
									<li>用户名：${loginUser.userNickname }</li>
									<li>级&nbsp;别：普通会员</li>
								</ul>
							</div>
	...
	<script type="text/javascript "
		src="${pageContext.request.contextPath }/js/quick_links.js "></script>
</body>
